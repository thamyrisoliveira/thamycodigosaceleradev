...
public class Carro {
    ...
    public boolean isMotoristaIdoso(){
        return this .getMotorista().getIdade() > 55;
    }
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
            if(placa == null || placa.isEmpty()){
                throw new NullPointerException("A placa não pode ser nula ou vazia.");
            }
            if(cor == null){
                throw new NullPointerException("Todo carro deve ter uma cor.");
            }
